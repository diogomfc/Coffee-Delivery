...
export function Checkout() {
  ...
  function handleSendOrder(evnt: FormEvent<HTMLFormElement>) {
    ...
    if (!Object.values(newOrder.address).length) {
      toast.error('Não é possível fazer o pedido sem um endereço válido', TOAST_CONFIG)
    ...
    toast.success('Pedido feito com sucesso', TOAST_CONFIG)
    resetCart()
    setTimeout(() => {
            ...
            <Container p={6} rounded="md" bg={theme.colors.base.card}>
              <HStack alignItems="flex-start">
                ...
                <VStack alignItems="flex-start" spacing={1}>
                  ...
                  Informe o endereço que deseja receber seu pedido.
                  </Text>
                </VStack>
              </HStack>
              <Grid
            ...
            <Container p={6} rounded="md" bg={theme.colors.base.card}>
              <HStack alignItems="flex-start">
                ...
                <VStack alignItems="flex-start" spacing={1}>
                  ...
                  <Text lineHeight={1.3} color={theme.colors.base.subtitle}>
                  Efetuar o pagamento na entrega. Escolha a forma de pagamento que deseja.
                  </Text>
                </VStack>
              </HStack>
