    ...
    <Container as="main" mb={12} pt={12} w="1100px" maxW="100vw">
      ...
      >
        <VStack flex={1} alignItems="flex-start">
          ...
          Uhuuuu! Pedido bem-sucedido
          </Heading>

          <Text color={theme.colors.base.text}>
          Agora é só aguardar, seu café chegará em breve..
          </Text>
          ...
          >
            ...
            <HStack my={4}>
              ...
              <VStack justifyContent="center" alignItems="flex-start">
                <Text lineHeight={1}>Visualização da Entrega</Text>
            ...
            <HStack my={4}>
              ...
              <VStack justifyContent="center" alignItems="flex-start">
                <Text lineHeight={1}>Pague na entrega</Text>
